...
def ensure_default_campaigns(db: Session) -> None:
    ...
    defaults = [
        PromoCampaign(
            ...
            message="Partner guesthouses offering warm stays and Kachura views — limited seasonal rates across the valley.",
            valley="Skardu",
            discount_label="Up to 20% off",
            cta_url="/plan",
            cta_label="Find Your Ideal Stay",
            season="off-season",
            active=True,
            sort_order=1,
        ),
        PromoCampaign(
            title="Deosai opening season",
            message="Book early for summer access to Deosai National Park — shared 4x4 pools fill quickly once the plateau opens.",
            valley="Deosai",
            discount_label="From Rs. 3,000/seat",
            cta_url="/pools",
            cta_label="Discover ride pools",
            season="off-season",
            active=True,
            sort_order=2,
        ),
        PromoCampaign(
            title="Khaplu heritage weekends",
            message="Culture guides and boutique stays in Ghanche — perfect for slow travel through eastern Gilgit-Baltistan.",
            valley="Khaplu",
            discount_label="Guide + stay bundles",
            cta_url="/plan",
            cta_label="Build Your Perfect Trip",
            season="off-season",
            active=True,
            sort_order=3,
        ),
